...
slug: what-is-docker-what-it can-do-for-you
...
pubDate: 2018-07-26T01:59:00+01:00
author: Márk Takács
image:
  url: "../../assets/what-is-docker.png"
  alt: ""
tags: ["tutorial"]
---
...
![Docker Images on the Docker Hub](../../assets/Docker_Images_on_Docker_Hub.png)
...
![Onepager website example](../../assets/onepager-website.gif)
...
![Onepager website example project structure](../../assets/onepager.png)
...
![Docker build flow](../../assets/Docker-build-flow.png)
...
![Docker ship flow](../../assets/Docker-ship-flow.png)
...
![Docker run flow](../../assets/Docker-run-flow.png)
...
![Onepage example dockerized](../../assets/onepage-website-boostrap-webpackdevserver-dockerized.png)
...
![Build development Docker image](../../assets/build-development-image.gif)
...
![Start webpack development server in docker container](../../assets/start-dev-server.gif)
...
![run Webpack development server with docker compose](../../assets/compose-up.gif)

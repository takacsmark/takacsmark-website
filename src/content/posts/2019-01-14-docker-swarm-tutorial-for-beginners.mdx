...
slug: docker-swarm-tutorial-for-beginners
...
pubDate: 2019-01-14T07:19:00+01:00
author: Márk Takács
image:
  url: "../../assets/docker-swarm.png"
  alt: ""
tags: ["tutorial"]
---
...
![Docker Swarm Scaled Service Host Name 1](../../assets/docker-swarm-host-name-1.png)
...
If you go to [http://localhost](http://localhost) and refresh the page a few times, you'll get alternating host names, because your request is served from different replicated containers. (Make sure to clear the browser cache during refresh to see the results, you can easily do this with CMD+SHIFT+R on Mac or CTRL+F5 on Windows and Linux, this will work with most browsers.)

![Docker Swarm Scaled Service Host Name 1](../../assets/docker-swarm-host-name-1.png)

![Docker Swarm Scaled Service Host Name 1](../../assets/docker-swarm-host-name-2.png)
...
We stay on the local machine for this exercise, I hope your computer has the power to run two virtual machines in parallel. If you don't have the power, you can do this exercise on [Play with Docker](http://play-with-docker.com/).

Docker has a handy tool called Docker machine that lets us create virtual machines locally and also in the cloud. Docker machine comes bundled with Docker on Mac and Windows, and it needs to be installed on Linux. Please refer to [the official documentation](https://docs.docker.com/machine/) if you need to install Docker machine.

Let's start up two VMs locally. Please make sure you have [Virtualbox](https://www.virtualbox.org/) installed before proceeding. Issue the below commands in terminal, please be patient it will take a while to create the machines.
...
![Docker Swarm Node app running in VM](../../assets/docker-swarm-vm-1.png)
...
![Docker Swarm VM visualizer](../../assets/docker-swarm-vm-visualizer.png)
...
The [Compose file reference](https://docs.docker.com/compose/compose-file/) specifies exactly whether an option is limited to either Compose or Swarm. We use the same file reference in both cases and we always double check if the settings are applicable to Swarm or Compose only.
...
![Docker Swarm Node application visualizer scaled to 6](../../assets/docker-swarm-visualizer-node-2.png)

Docker has various options for deployment configuration, please refer to the [Compose file reference](https://docs.docker.com/compose/compose-file/) to create the right configuration for your project.

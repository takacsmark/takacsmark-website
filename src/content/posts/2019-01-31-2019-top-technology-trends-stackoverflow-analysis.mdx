...
slug: 2019-top-technology-trends-stackoverflow-analysis
...
pubDate: 2019-01-31T07:19:00+01:00
author: Márk Takács
image:
  url: "../../assets/2019-Technology-Trends-Stackoverflow-Analysis.png"
  alt: ""
tags: ["tutorial"]
---
...
This post is the result of several days of Stackoverflow data mining. The insights and figures you find in this article come from the December 2, 2018 [Stack Exchange data dump](https://archive.org/download/stackexchange).
...
- [Kotlin](https://kotlinlang.org/) is an exceptional programming language, you have the ability to code for JVM, develop Android, Javascript and Native applications with the use of the same language. This unique and powerful value proposition brought Kotlin to the top of this list.
- [Vue](https://vuejs.org/), [React](https://reactjs.org/), [React Native](https://facebook.github.io/react-native/), [Redux](https://redux.js.org/) and [Angular](https://angular.io/) (on the established tags list) represent the **single page application** libraries and frameworks with their versatile solutions to bring the same code also to mobile devices.
...
- [Firebase](https://firebase.google.com/), Google's web application and mobile development platform with excellent integration options and cloud backed features also made it to the top 15.
...
- Google's mobile application SDK, [Flutter](https://flutter.io/) just reached version 1.0.
- Flutter is not the only emerging product by Google; cloud components like the [Firestore](https://firebase.google.com/docs/firestore/) NoSQL database, [Google Assistant Actions](https://developers.google.com/actions/) and [Google Cloud Functions](https://firebase.google.com/docs/functions/functions-and-firebase) are gaining momentum.
- Web application development is strongly represented by [Bootstrap 4](https://blog.getbootstrap.com/), [Vuex](https://vuex.vuejs.org/), [Axios](https://github.com/axios/axios) and [Jest](https://jestjs.io/), the first testing framework on the top list.
- We find exciting niche tags here like the [Discord messaging API](https://discordapp.com/) and [Hyperledger](https://www.hyperledger.org/) an umbrella project for open-source blockchain related tools by the Linux Foundation.
...
**Web application development** is again heavily present with Angular, Webpack, [Cypress](https://www.cypress.io/), an end-to-end Javascript testing framework, [nest](https://nestjs.com/) and [Next.js](https://nextjs.org/), a production grade React framework.
...
[Laravel](https://laravel.com/), [Postgres](https://www.postgresql.org/) and [Kubernetes](https://kubernetes.io/) are a nice addition to your focus list.

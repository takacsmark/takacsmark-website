...
slug: how-to-get-docker-container-ip-address
...
pubDate: 2019-05-12T07:19:00+01:00
author: Márk Takács
image:
  url: "../../assets/docker-tips-container-ip.png"
  alt: ""
...
You can read about this in the [Docker docs](https://docs.docker.com/develop/develop-images/dockerfile_best-practices/) or in my [in my Dockerfile best practices tutorial](https://takacsmark.com/dockerfile-tutorial-by-example-dockerfile-best-practices-2018/#containers-should-be-ephemeral).

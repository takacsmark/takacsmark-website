...
slug: node-js-trends-actions-2019-stackoverflow-data
...
pubDate: 2019-05-06T07:19:00+01:00
author: Márk Takács
image:
  url: "../../assets/28-Node-js-Trends-Actions-2019.png"
  alt: ""
tags: ["trends"]
---
...
- Use [Socket.io](https://socket.io/) for real-time bidirectional communication.
...
- Use [sequelize.js](https://github.com/sequelize/sequelize) for your SQL data needs.
...
- Try [Discord](https://discordapp.com/) and [discord.js](https://discord.js.org/#/).
- Need help with UI testing and test automation? [Puppeteer](https://github.com/GoogleChrome/puppeteer) might just be right.
- Consider [Axios](https://github.com/axios/axios) for your Node.js requests. (Axios is my go-to solution in Node and React projects, they have 58k stars on GitHub right now.)
- Run a pilot with [Google's Cloud Platform](https://cloud.google.com/).
- Try the [Microsoft](https://dev.botframework.com/) bot framework for your enterprise chat bots.
- Check out [Firebase](https://firebase.google.com/).
- Definitely add [JWT](https://jwt.io/) to your security stack.
- Check out [GraphQL](https://graphql.org/learn/) for API data.
- See if you can utilize [pm2](http://pm2.keymetrics.io/) in production operations.
- Need a solution to manage file uploads? Try [Multer](https://github.com/expressjs/multer).
...
- Start a [Dialogflow](https://dialogflow.com/) pilot.
- Check if [TypeORM](https://typeorm.io/#/) is the ORM you've been looking for.
- Try [nodejs-stream](https://nodejs.org/api/stream.html) for streaming data.
- No preferred Node.js testing framework yet? Try [Jest](https://jestjs.io/)!
...
**This article is an extension to my [previous article about Javascript trends](https://takacsmark.com/25-top-javascript-trends-actions-2019-stackoverflow-data/); this time we take a closer look at what's hot in the Node.js ecosystem and what concrete actions you can take today to keep up with the trend.**
...
![img](../../assets/njs-js-base-so-questions-trends-2018.png)
...
![img](../../assets/njs-server-side-so-questions-trends-2018.png)

**Express** is the clear winner on the server side. Sails made it to the top 25 tags list above, but its usage shows decline.

**GraphQL and Axios** also demonstrate high growth, and more and more **communications and chat** solutions appear on the growth charts, like Discord or [Microsoft's bot framework](https://dev.botframework.com/).
...
![img](../../assets/njs-db-so-questions-per-total-2018.png)
...
![img](../../assets/njs-devops-so-questions-per-total-2018.png)
...
![img](../../assets/njs-web-frameworks-so-questions-trends-2018.png)

I also added a separate figure for less prominent frameworks; namely Nest, Next and Nuxt.

![img](../../assets/njs-web-frameworks-1-so-questions-trends-2018.png)
...
> - Consider [Axios](https://github.com/axios/axios) for your Node.js requests. (Axios is my go-to solution in Node and React projects, they have 58k stars on GitHub right now.)
> - Run a pilot with [Google's Cloud Platform](https://cloud.google.com/).
> - Try the [Microsoft bot framework](https://dev.botframework.com/) for your enterprise chat bots.
> - Check out [Firebase](https://firebase.google.com/).
> - Definitely add [JWT](https://jwt.io/) to your security pack.
> - Check out [GraphQL](https://graphql.org/learn/) for API data.
> - See if you can utilize [pm2](http://pm2.keymetrics.io/) in production operations.
> - Need a solution to manage file uploads? Try [Multer](https://github.com/expressjs/multer).

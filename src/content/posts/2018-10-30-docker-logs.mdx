...
pubDate: 2018-10-30T07:39:00+01:00
author: Márk Takács
image:
  url: "../../assets/docker-logs.png"
  alt: ""
tags: ["tutorial"]
---
...
You can find the up-to-date spec on the [Docker site](https://docs.docker.com/config/daemon/#read-the-logs).

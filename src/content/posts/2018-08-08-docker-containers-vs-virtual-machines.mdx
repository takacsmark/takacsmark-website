...
pubDate: 2018-08-08T01:59:00+01:00
author: Márk Takács
image:
  url: "../../assets/containers-vs-vms.png"
  alt: ""
tags: ["tutorial"]
---
## Table of Contents
...
You can find code-along Docker tutorials for free on my [blog](https://takacsmark.com) and my [youtube channel](https://www.youtube.com/takacsmark), if you prefer a more techie approach. I’ll keep adding more hard-core tech stuff, so stay tuned.
...
![Nginx container processes in Vagrant ubuntu bionic](../../assets/Nginx_containers_ubuntu_vagrant.png)
...
![Docker containers vs virtual machines](../../assets/container_vs_vm.png)

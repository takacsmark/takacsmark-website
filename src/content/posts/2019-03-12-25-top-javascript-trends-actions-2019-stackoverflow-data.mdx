...
slug: top-javascript-trends-actions-2019-stackoverflow-data
...
pubDate: 2019-03-12T07:19:00+01:00
author: Márk Takács
image:
  url: "../../assets/25-Top-Javascript-Trends-Actions-2019.png"
  alt: ""
tags: ["trends"]
---
...
- If you are starting a new web project, **give [Vue](https://vuejs.org/) a try**.
- Integrate **[Ecmascript 6](http://es6-features.org/#Constants) into your development standards**.
- Consider **[Typescript](https://www.typescriptlang.org/) in complex Javascript applications**.
- Experiment with the **[MEAN stack](http://mean.io/)** to combine the benefits of Angular, Node with Express and Mongodb.
- You can use **Wordpress with React or Angular**, check it out.

_Domains you should consider for future skill building._

- Are you already into React? **Bring your user experience to mobile with [React Native](https://facebook.github.io/react-native/)**.
- Definitely **run a pilot with [Firebase](https://firebase.google.com/)**, here is some [good reading](https://medium.freecodecamp.org/firebase-the-great-the-meh-and-the-ugly-a07252fbcf15).
- **[Webpack](https://webpack.js.org/)** emerged as the packaging tool of choice.
- **Connecting to MongoDB from Node?** [Mongoose](https://mongoosejs.com/) is the preferred tool by most projects.
- **Not using [Redux](https://redux.js.org/) for state management?** Revisit this point.
- **Combine Javascript with Python's power** to solve new kind of problems.
- Try **[the Charts library](https://www.chartjs.org/)** to create beautiful charts with Javascript.
- **Build cross-platform applications with the [Ionic framework](https://ionicframework.com/)** and use Angular, React or Vue during the process.
- **Use [three.js](https://threejs.org/) to create 3D** visuals.

_New tech to explore._

- **Get started with [Angular 7](https://angular.io/guide/quickstart) and prepare for Angular 8**.
- Building an enterprise grade app? **Consider [Next.js](https://nextjs.org/) and [Gatsby](https://www.gatsbyjs.org/) with React or [Nuxt.js](https://nuxtjs.org/) with Vue**.
- Need help with **UI testing and test automation**? [Puppeteer](https://github.com/GoogleChrome/puppeteer) might just be right.
- Need a good **React UI component framework for internal desktop applications**? Have a look at [Ant design](https://ant.design/).
- Get started with programming bots for **[Discord](https://discordapp.com/)**, the all-in-one voice and text chat for gamers.
- Experiment with **[Apollo and GraphQL](https://www.apollographql.com/)**.
- **Consider [Axios](https://github.com/axios/axios) for HTTP request from web and Node.js**.
- **Start learning React** with [create-react-app](https://github.com/facebook/create-react-app).
...
![img](../../assets/prog-lang-so-questions-per-total-2018.png)
...
You find two programming languages with above average growth; **Python and Javascript**. Python demonstrates extremely high demand, you can read more about the details in my [Python article](https://takacsmark.com/top-14-python-skills-businesses-2019-stackoverflow-data/).
...
![img](../../assets/js-base-so-questions-trends-2018.png)

![img](../../assets/jszoom-base-so-questions-trends-2018.png)
...
![img](../../assets/classic-jsweb-so-questions-per-total-2018.png)
...
![img](../../assets/modern-jsweb-so-questions-trends-2018.png)

Our old friends are all going down, their role is taken over by Angular, React and Vue for now.

![img](../../assets/modern-t2-jsweb-so-questions-trends-2018.png)
...
![img](../../assets/server-side-js-so-questions-trends-2018.png)
...
> - If you are starting a new web project, give [Vue](https://vuejs.org/) a try.
> - Integrate [Ecmascript 6](http://es6-features.org/#Constants) into your development standards.
> - Consider [Typescript](https://www.typescriptlang.org/) for complex Javascript applications.
> - Experiment with the [MEAN stack](http://mean.io/).
> - You can use Wordpress with React or Angular, check it out.
...
>
> - Are you already into React? Bring your user experience to mobile with [React Native](https://facebook.github.io/react-native/).
> - Definitely experiment with [Firebase](https://firebase.google.com/).
> - Consider moving to [Webpack](https://webpack.js.org/).
> - Connecting to MongoDB from Node? [Mongoose](https://mongoosejs.com/) is probably to package you need.
> - Not using [Redux](https://redux.js.org/) for state management? Revisit the point.
> - Combine Javascript with Python's power to solve new kind of problems.
> - Try [the Charts library](https://www.chartjs.org/) to create beautiful charts with Javascript.
> - Build cross-platform applications with the [Ionic framework](https://ionicframework.com/) and use Angular, React or Vue during the process.
> - Use [three.js](https://threejs.org/) to create 3D visuals.
...
- **[Vuetify.js](https://v1.vuetifyjs.com/en/)** is a Material design component library for Vue.js. 1.0.0 was released in February 2018, 2.0.0 alpha has been released recently.
- **[Nuxt.js](https://nuxtjs.org/)** is a framework for Vue.js that you can use to build applications for web, desktop and mobile.
- **[Next.js](https://nextjs.org/)** is a React framework that features all best practices to create a production grade enterprise React application. The project has over 35k stars on GitHub.
- **[Puppeteer](https://github.com/GoogleChrome/puppeteer)** is a headless Chrome Node API for all your scraping needs be it integrated testing, UI testing or pre-rendered content generation.
- **[Ant design](https://ant.design/docs/spec/introduce)** is a design specification focused on internal desktop applications in the enterprise. The design principles are available in an implemented form for React, Angular and Vue.
- **[Gatsby](https://www.gatsbyjs.org/)** is another React website framework with over 32k stars on GitHub.
- The appearance of **[Discord](https://discordapp.com/)**, the all-in-one voice and text chat for gamers, on this list means that the world of Javascript is also touched by gaming/streaming/e-sports revolution.
- Our report would not be complete without **[the Apollo platform](https://www.apollographql.com/)** and GraphQL.
- **[Axios](https://github.com/axios/axios)** is the HTTP request library that I use in all Node.js projects. It seems I'm not alone.
- **Starting out with React?** Check out [create-react-app](https://github.com/facebook/create-react-app).

> Actions you may take:
>
> - Get started with [Angular 7](https://angular.io/guide/quickstart) and Angular 8.
> - Building an enterprise grade app? Consider [Next.js](https://nextjs.org/) and [Gatsby](https://www.gatsbyjs.org/) with React or [Nuxt.js](https://nuxtjs.org/) with Vue.
> - Need help with UI testing and test automation? [Puppeteer](https://github.com/GoogleChrome/puppeteer) might just be right.
> - Need a good React UI component framework for internal desktop applications? Have a look at [Ant design](https://ant.design/).
> - Get started with programming bots for [Discord](https://discordapp.com/), the all-in-one voice and text chat for gamers.

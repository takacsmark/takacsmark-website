...
slug: docker-compose-tutorial-beginners-by-example-basics
...
pubDate: 2018-09-18T01:59:00+01:00
author: Márk Takács
image:
  url: "../../assets/docker-compose-beginners-all-you-need-to-know.png"
  alt: ""
tags: ["tutorial"]
---
...
This file is in the `YAML` format, which is a "human friendly data serialization standard for all programming languages", as seen on [yaml.org.](http://yaml.org/)
...
To test the app, you can post a student with curl like this (or alternatively you can use a tool like [Postman](https://www.getpostman.com/)):
...
The best resource for writing Compose files is the [official Compose file reference](https://docs.docker.com/compose/compose-file/). I usually have this page open all the time, this single page contains all options and possibilities that you can use in the Compose file.

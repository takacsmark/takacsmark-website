...
slug: devops-docker-trends-2019
...
pubDate: 2019-09-08T07:19:00+01:00
author: Márk Takács
image:
  url: "../../assets/devops-docker-trends.png"
  alt: ""
tags: ["trends"]
---
...
- **[Terraform](https://www.terraform.io/) and [Vagrant](https://www.vagrantup.com/)** are both products from HashiCorp. Terraform is a tool for building infrastructure. The key difference between Terraform and Ansible, Chef and Puppet from before, is that you use Terraform to create your infrastructure and you use Ansible, Chef and Puppet to manage the configuration of the infrastructure you built with Terraform. Terraform can build and manage large scale infrastructures across multiple cloud providers. Vagrant is a similar tool, but it's used to manage development environments locally.
- **[Sonarqube](https://www.sonarqube.org/)** is your tool for code inspection. _It helps you write high quality code and reduce technical debt by checking your code for bugs, security vulnerabilities, maintainability issues._ It integrates well with other tools like Jenkins and Git.

If you look back at the tables, you find that **[Java](https://www.java.com/en/download/)** is the only programming language that appears on both lists. You see Python and Node.js gain immense popularity lately and their communities are rapidly growing. I am also a great fan of both languages. **If you look at corporate reality, you find that Java still dominates application development and therefore it's a key skill in your DevOps journey.**
...
Enterprises usually go for a different product. A popular solution is the [Nexus repository manager](https://www.sonatype.com/nexus-repository-sonatype) by Sonatype.
...
![img](../../assets/docker-so-questions-per-total-2018.png)
...
![img](../../assets/docker-base-so-questions-trends-2018.png)
...
>
> - Start learning [Docker](https://docker.com) with special focus on custom Docker images and Compose.
> - Start learning container orchestration building Swarm skills and learning [Kubernetes](https://kubernetes.io) in detail.
> - Set up your [Jenkins](https://jenkins.io/) development pipeline; start measuring and improving the performance of your production line.
...
- **[Sonarqube](https://www.sonarqube.org/)** code inspection is becoming a vital part of automation architectures.
...
> Actions you may take:
>
> - Set up a [GitLab](https://about.gitlab.com/) environment, add it to your DevOps stack as a source control and CI/CD facility.
> - Try [Sonarqube](https://www.sonarqube.org/) in a small project that you are starting now.
> - Think of new ways to maximize the value of your configuration management with tool like Ansible.
> - Create a [Spring boot](https://spring.io/projects/spring-boot) application with Docker. A Restful API backend would be a great candidate for your first pilot.
...
> - Consider [Django](https://www.djangoproject.com/) or [Ruby on Rails](https://rubyonrails.org/) for your next internal web application.
> - Identify components in your development and testing workflow that you may host in public cloud and give it a go with [AWS](https://aws.amazon.com/).
...
> - Try [Traefik](https://traefik.io/) as a reverse-proxy and load-balancer and compare your development and operations metrics to your current solution.
> - Encourage your development and operations team members to launch [Minikube](https://kubernetes.io/docs/tasks/tools/install-minikube/) on their computers and practice Kubernetes techniques.

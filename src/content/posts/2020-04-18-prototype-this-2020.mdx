...
pubDate: 2020-04-18T07:19:00+01:00
author: Márk Takács
image:
  url: "../../assets/prototype-this-2020.png"
  alt: ""
tags: ["trends"]
---
...
The backing data is a dump of all Stackoverflow questions and answers. Stackoverflow releases their data every quarter and it's available in the internet archives at [https://archive.org/download/stackexchange](https://archive.org/download/stackexchange).
...
![img](../../assets/questions-per-month-top-programming-languages.png)
...
![img](../../assets/tags-next-to-python.png)
...
**The top established tags** are usually the ones that are used by most projects to accomplish core tasks. **[Keras](https://keras.io/)**, **[tensorflow](https://www.tensorflow.org/)** and **[scikit-learn](https://scikit-learn.org/stable/)** are mainstream machine learning tech, all great to start learning.

**[Pandas](https://pandas.pydata.org/)** and the **dataframe** are fundamental data manipulation tools, this report is also made with them.

**Anaconda** and **Jupyter notebook** are in the growth table. **You can use [Anaconda](https://www.anaconda.com/) to conduct professional grade data science and ML work, at the same time it's a great spot to get your hands dirty, it contains all the tools you need to get started.**
...
**Thanks to Google we have a cloud version of the notebook available for free at [Google Colab](https://colab.research.google.com).** _If you build your first Python data crunching or machine learning prototype, start here!_
...
![img](../../assets/tags-next-to-machine-learning.png)

![img](../../assets/tags-next-to-data-science.png)
...
**[Amazon Sagemaker](http://go.takacsmark.com?id=61108X1384518&xs=1&url=https%3A%2F%2Faws.amazon.com%2Fsagemaker%2F) and Google Colaboratory** are emerging tags and we have [Azure Machine Learning Studio](https://studio.azureml.net/) and [IBM Watson Studio](http://go.takacsmark.com?id=61108X1384518&xs=1&url=https%3A%2F%2Fwww.ibm.com%2Fhu-en%2Fmarketplace%2Fwatson-studio) to choose from. _AI is becoming industrialized, it's important that you build skills on at least one of these platforms._

**Additional prominent trend is to bring machine learning to mobile and edge devices.** The top growing machine learning framework in the trending tags, **[Pytorch](https://pytorch.org/)**, has capabilities to run ML on edge devices including iOS and Android.

**Google's popular Tensorflow machine learning project is moving in the same direction with [Tensorflow lite](https://www.tensorflow.org/lite).** Tensorflow also provides [Tensorflow.js](https://www.tensorflow.org/js) (the top emerging tag in the machine learning table) **a Javascript library to use ML in the browser and Node.js**.

**Apache spark appears both in the Python and machine learning growth tables**. Apache Spark and **pyspark** (Python API to support Apache Spark) let you analyze large volumes of data on clusters. **Microsoft's Apache Spark based analytics service, [Azure Databricks](http://go.takacsmark.com?id=61108X1384518&xs=1&url=https%3A%2F%2Fazure.microsoft.com%2Fen-us%2Fservices%2Fdatabricks%2F), is the top item on the Python emerging tags list.**

**Real time object detection and industrial grade nlp are represented by [Yolo](https://pjreddie.com/darknet/yolo/) and [Spacy](https://spacy.io/).** _I made a quick prototype with Yolo and got a cool image with boxes around every object. It's too personal to share, though; my wife is standing there between a potted plant and a backpack smiling frantically surrounded by box that says: "person"._
...
![img](../../assets/openaigym.png)

**The [Gym toolkit](https://gym.openai.com/) is an open-source project to build reinforcement learning projects.** You can use it to teach your machine to walk or play games.
...
Photo credit [Openai](https://gym.openai.com/).
...
Context is the weak point of present chat bots and virtual assistants. **[Rasa, the open source contextual assistant](https://rasa.com/) has 2M+ downloads is available for free or with enterprise support.** Sounds like a chance for clever business prototype.
...
**For more information visit the [Nvidia Jetson site](http://go.takacsmark.com?id=61108X1384518&xs=1&url=https%3A%2F%2Fwww.nvidia.com%2Fen-us%2Fautonomous-machines%2Fjetson-store%2F).**

Photo credit: [Nvidia](https://www.nvidia.com)

![img](../../assets/nvidia-jetson-nano-dev-kit-2c50-D.png)

![img](../../assets/crazyflie.png)

**One more cool example is the [Crazyflie open source flying develeopment platform by Bitcraze](http://go.takacsmark.com?id=61108X1384518&xs=1&url=https%3A%2F%2Fstore.bitcraze.io%2Fproducts%2Fcrazyflie-2-1).**
...
Photo credit: [Bitcraze](https://www.bitcraze.io/)

## Applications created for customers on the web, mobile and the enterprise

![img](../../assets/tags-next-to-javascript.png)
...
**[Gatsby](https://www.gatsbyjs.org/) and [Next.js](https://nextjs.org/) are such frameworks for React.** They don't appear in the table, but a similar solution for Vue, [Nuxt.js](https://nuxtjs.org/), is amongst emerging tags.

![img](../../assets/questions-per-month-top-spa.png)

![img](../../assets/questions-per-month-top-js-framework.png)
...
**You see that Angular and React are far ahead with Vue in the third position.** **Adding [Svelte](https://svelte.dev/) to the picture has no strong visual value**, but it's a fast growing newcomer (it's on the emerging list on the previous page).
...
**[Nest.js](https://nestjs.com/) is built to give you production grade Javascript architecture on the backend.** It has controllers, services, middleware, database, authentication, GraphQL, Websockets and more. **Nest has been added to [JHipster,](https://www.jhipster.tech/) my beloved application accelerator right now, as a backend solution.** _JHipster uses Spring Boot as the backend, having Nest as an alternative to Spring Boot shows its potential in enterprise implementations._

**Nest can run two Node.js server solutions under the hood; Express or [Fastify](https://www.fastify.io/).** Express is the Node.js classic, while Fastify, as the name suggests, is tweaked towards performance. _Express has not received new commits in the past 9 months on GitHub, which makes projects like Fastify highly welcome._
...
**Here comes [Google's Firebase](https://firebase.google.com/), a development platform that has the right tools and infrastructure components you need to launch your web or mobile app quickly.** (Firebase is on the trending tags list on the previous page and appears in several tables in this report.)
...
**Data editing and visualization has reached Javascript, too**. **[Tabulator](http://tabulator.info/)**, a table editing Javascript library pops up on the emerging tags list.

One of Python's essential plotting libraries, **[Plotly, now provides a Javascript library](https://plot.ly/javascript/) for interactive data visualization on the web**. It also works with React.

**[Mpld3](https://mpld3.github.io/) brings together the power of Matplotlib and d3js to create interactive data visualizations from Python to be presented to your users with Javascript.** It's on my backlog to check how it fits my blog.

To give you another visualization option, you might consider **[Apex charts](https://apexcharts.com/), compatible with all major Javascript frameworks, with stunning looks and 8.5k GitHub stars**.

![img](../../assets/tags-next-to-java.png)
...
**Do you mind if I write about the [Spring framework](https://spring.io/) and Spring Boot right away?** _Spring is the top server side tech on the heat map and Spring boot is the fastest growing Java related established tech in the table below._
...
The amount of experience built into Spring is astonishing. **If this does not sound intimidating, you can experiment with [JHipster](https://www.jhipster.tech/), a project that generates Spring applications plus Angular/React front-ends as a monolith or a microservices architecture ready to run in production.**
...
**[Micronaut](https://micronaut.io/), a Java based framework to build microservices and serverless applications, promises to deliver on the key weak points of Java; startup time and memory consumption.** _If you take the time and test it out, please let me know about your findings._

**[OpenJFX](https://openjfx.io/) is an open-source project to build cross-platform client applications in Java.** Cross platform development is catching up with many languages, and Java is also joining in with JavaFx.

**Staying on the server side, let's mention Python's contribution. [Django](https://www.djangoproject.com/) and [Flask](https://flask.palletsprojects.com/en/1.1.x/)** are both on the Python top list and they are a beloved alternatives to Java and Node.js on the server side. They are used for web applications and as microservice backends. **[Connexion](https://github.com/zalando/connexion), a project that serves your HTTP request based on your OpeanAPI YAML specification using Flask, seems to be a hot candidate for a prototype.**
...
![img](../../assets/tags-next-to-mobile.png)

![img](../../assets/tags-next-to-android.png)

![img](../../assets/tags-next-to-ios.png)
...
**It's obvious that I have to put [React Native](https://reactnative.dev/) on my shortlist.** It's a top growth tag next to iOS and Android, too. I've got React skills (that I acquired through blood, sweat and tears), it seems like a no brainer. *But I have a concern.*
...
**We've got [Xamarin](https://dotnet.microsoft.com/apps/xamarin) and [Ionic](https://ionicframework.com/) in the growth tables and [Apache Cordova](https://cordova.apache.org/) on the heat map**. I would not go with Cordova, because it's not on the growth list.
...
**To complete the short list let's look at the growth next to the mobile tag, too. [Flutter by Google](https://flutter.dev/) and its programming language, Dart, appear on top.**
...
![img](../../assets/tags-next-to-architecture.png)

![img](../../assets/tags-next-to-enterprise.png)
...
**I built mine with [JHipster](https://www.jhipster.tech) and I would recommend it to architects and devs who want to play hands on.**
...
If you want to get into Spring Boot a little deeper, [I recommend the courses of this author on Udemy](https://fave.co/2Rvp6by).

On the design side **Domain driven design** and **Clean architecture** are the concepts trending on Stackoverflow. **To get started check out [Domain Driven Design by Eric Evans](https://amzn.to/2VAjyhc) and [Clean Architecture: A Craftsman's Guide to Software Structure and Design by Robert C. Martin a.k.a. Uncle Bob.](https://amzn.to/2RIBNQo)**

![img](../../assets/tags-next-to-devops.png)

![img](../../assets/tags-next-to-docker.png)
...
No wonder I'm a great fan of [The Phoenix Project,](https://amzn.to/3cl9SOr) a one of a kind IT novel by Gene Kim, that shows dev and ops the way I like to look at IT.
...
**You can build your first Kubernetes prototype with [Minikube](https://kubernetes.io/docs/setup/learning-environment/minikube/) and learn the basics. Then try running applications on GCP, AWS and Azure with their respective managed Kubernetes offerings.**

**[Jenkins](https://jenkins.io/) is at the core of automation, it's the most popular CI/CD solution for corporations.** _While there are various cloud options available like CircleCI or Travis, you can always set up your own Jenkins on your own servers._ Try running Jenkins with Docker as a prototype, I have a blog post almost ready to publish to show you how you can do this.

**Another key tool that you can set up on premises is [Gitlab](https://about.gitlab.com/)**. _Gitlab with Jenkins is a frequent combination in enterprise projects._

**Moving further into automation you find infrastructure automation with [Terraform by HashiCorp](https://www.terraform.io/) and configuration management with [Ansible](https://www.ansible.com/), [Chef](https://www.chef.io/) and [Puppet](https://puppet.com/)**. You find most of them in the top growth tables. _Prototyping these tools is pretty easy, just take any web application prototype you already have and deploy it to a cloud service with these tools._

**There are good number of solutions to help you deploy a production level Kubernetes cluster**. [Kubespray](http://go.takacsmark.com?id=61108X1384518&xs=1&url=https%3A%2F%2Fgithub.com%2Fkubernetes-sigs%2Fkubespray) works with all major cloud services, supports Ansible and Vagrant and has great compatibility with 3rd party components.

**If you deploy your apps on edge devices, you might want to check out [microk8s](https://microk8s.io/), the zero-ops Kubernetes for workstations IoT and embedded applications.**

Identity and access management is an aspect you have to handle in every project. **[Keycloak](https://www.keycloak.org/), a project backed by RedHat provides all-around open-source identity and access management.** _I just built a few small prototypes with it and liked the experience a lot. I rebuilt the prototypes with Firebase Auth and liked it even better. I'm also considering another rebuild with AWS Cognito._

**If you are new to Docker and willing to learn, check out my [Docker tutorial book I teach in classroom trainings; Get Started with Docker in your Projects - through Examples](https://takacsmark.com/get-started-with-docker-in-your-projects-through-examples/).**

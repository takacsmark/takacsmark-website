...
slug: getting-started-with-docker-in-your-project-step-by-step-tutorial
...
pubDate: 2016-10-15T8:07:00+01:00
author: Márk Takács
image:
  url: "../../assets/docker-tutorial-getting-started.png"
  alt: "TODO"
tags: ["tutorial"]
---
...
![Welcome to Nginx](../../assets/welcome-to-nginx.jpg)
...
![Nginx without compression](/assets/images/in-content/nginx-without-gzip-response-chrome.jpg)

![Nginx with compression](/assets/images/in-content/nginx-with-gzip-response-chrome.jpg)
...
![Hello word with nginx](/assets/images/in-content/hello-word-nginx.jpg)

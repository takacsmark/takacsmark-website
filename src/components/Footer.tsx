  ...
  return (
    <footer className="bg-black">
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32 lg:pt-8">
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-0 lg:flex lg:items-center lg:justify-between">
          <div>
          ...
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <div className="mt-4 sm:ml-4 sm:mt-0 sm:shrink-0">
              <button
                type="submit"
                className="flex w-full items-center justify-center bg-white px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-gray-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500"
              >
                Subscribe
              </button>
            </div>
